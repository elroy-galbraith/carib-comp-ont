...
* **Citation:** Donalds, C., & Barclay, C. (2022). Beyond technical measures: a value-focused thinking appraisal of strategic drivers in improving information security policy compliance. *European Journal of Information Systems*, 31(1), 58-73. 15  
* **Link:** [https://doi.org/10.1080/0960085X.2021.1978344](https://doi.org/10.1080/0960085X.2021.1978344)  
* **Accessibility:** \[Full text read\]  
...
### **\[Alharbi et al., 2026\] Characterising LLM-Generated Competency Questions**

* **Citation:** Alharbi, R., Tamma, V., Payne, T. R., & de Berardinis, J. (2026). Characterising LLM-Generated Competency Questions: a Cross-Domain Empirical Study using Open and Closed Models. *arXiv preprint arXiv:2604.16258*. 11  
* **Link:** [https://arxiv.org/abs/2604.16258](https://arxiv.org/abs/2604.16258)  
* **Accessibility:** \[Full text read\]  
...
* **Method snapshot:** Multi-dimensional framework using Sentence-BERT embeddings for semantic diversity and Gemini 2.5 Pro as a relevance evaluator, validated by human experts across five domains.11  
* **Where we differ:** While Alharbi et al. evaluate the *generation of requirements* (the questions), we evaluate the *fidelity of the extracted graph*. We adopt their multi-faceted characterization (readability and relevance) but apply it to a "quarantined" corpus (Bahamas DPA 2003\) to measure extraction precision rather than requirement elicitation.11  
* **Strength of "where we differ":** \[strong — copyable into paper\]
...
### **\[Turaga et al., 2025\] CO2 (Co-Compliance Officer)**

* **Citation:** Turaga, V. S. P., Pahi, T., Tjoa, S., Siami-Namini, S., & Namin, A. S. (2025). CO2 (Co-Compliance Officer): An LLM-Based Ontology-Driven Methodology for Generating Knowledge Graphs and AI Compliance Checking. *IEEE Access*, 13, 210576-210606. 39  
* **Link:** [https://doi.org/10.1109/ACCESS.2025.3639228](https://doi.org/10.1109/ACCESS.2025.3639228)  
* **Accessibility:** \[Full text read\]  
...
* **Where we differ:** CO2 is a *specialized compliance checker* for the high-risk logic of the EU AI Act. Our project is a *general jurisdictional repository* for the Caribbean. We focus on the "low-friction" aspect of Git-PR workflows for general statutes (like Caribbean DPAs), whereas CO2 targets the complex lifecycle and risk management specific to AI systems.39  
* **Strength of "where we differ":** \[solid\]

### **\[Janatian et al., 2023\] From Text to Structure: LLMs for Legal Expert Systems**

* **Citation:** Janatian, S., Westermann, H., Tan, J., Savelka, J., & Benyekhlef, K. (2023). From Text to Structure: Using Large Language Models to Support the Development of Legal Expert Systems. *Legal Knowledge and Information Systems (JURIX 2023)*, 167-176. 40  
* **Link:** [https://doi.org/10.3233/FAIA230962](https://doi.org/10.3233/FAIA230962) (arXiv: [2311.04911](https://arxiv.org/abs/2311.04911))  
* **Accessibility:** \[Full text read\]  
* **What they do:** The paper investigates the degree to which GPT-4 can automatically extract structured representations (pathways) from legislation as part of the JusticeBot expert-system platform.40 In a blind comparison against expert-created gold standards, 60% of generated pathways were judged equivalent or superior to manually created ones, with redundant nodes effectively removed.40  
* **Method snapshot:** Empirical study using the JusticeBot methodology; evaluated through blind comparison with expert-created gold standards.40  
* **Where we differ:** Their focus is on generating *executable decision logic* for the JusticeBot platform. Our focus is on an *auditable knowledge base* in a Markdown vault. We prioritize the human review of the "inbox → extract → validate" pipeline within a Git-PR workflow, ensuring the graph is maintainable alongside legislative updates rather than optimized for downstream rule execution.40  
* **Strength of "where we differ":** \[solid\]
...
| **LLM-Assisted Relevance (LARS)** | A 4-point Likert scale (Explicit, Inferable, Contextual, Irrelevant) for extracted entities. | Alharbi et al. 11 |
